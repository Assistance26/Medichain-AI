      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <AnimatePresence>
          {showPrediction && (
            <motion.button 
              onClick={handleReset}
              className="mt-6 py-2 px-4 bg-white/5 backdrop-blur-sm text-muted-foreground hover:bg-white/10 rounded-lg transition-all duration-300 border border-white/10 hover:border-white/20 transform hover:-translate-y-1 hover:shadow-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 20 }}
